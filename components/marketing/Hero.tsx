...
export function Hero() {
  return (
    <section className="grid items-center gap-9 py-8 md:grid-cols-[1.1fr_0.9fr]">
      <div>
        <span className="inline-block rounded-full bg-uno-yellow/15 px-3 py-1 text-xs font-bold uppercase tracking-wide text-uno-yellow">
        ...
        <h1 className="mt-4 text-5xl font-black leading-[1.04] tracking-tight">
          ...
          <span className="text-uno-yellow">Infinity rules, your call.</span>
        </h1>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/play?create=1" className={cn(buttonVariants({ size: 'lg' }), 'bg-uno-yellow text-uno-ink hover:bg-uno-yellow/90')}>
            Create a Room
          </Link>
