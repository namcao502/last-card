...
export interface RoomMeta { code: string; hostId: string; phase: 'lobby' | 'playing' | 'duel' | 'bombResponse' | 'gameOver'; maxPlayers: number; config: import('@last-card/engine').RuleConfig; paused?: boolean }
